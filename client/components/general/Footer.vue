  ...
  <v-app>
    ...
    >
      <v-container>
        ...
        >
          <v-col cols="6" xl="5" lg="5" md="5" sm="5" class="white--text">
              <span
          ...
          <v-col cols="6" xl="2" lg="2" md="2" sm="2" class="white--text" style="justify-content: flex-end">
              <span
          ...
          <v-spacer></v-spacer>
          <v-col cols="12" id="media_follow_us_on" class="text-center white--text">
